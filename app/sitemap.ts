...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/coffrets`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE_URL}/cartes-cadeaux`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
  ...
  return [...staticPages, ...occasionPages, ...categoryPages, ...productPages]
}
